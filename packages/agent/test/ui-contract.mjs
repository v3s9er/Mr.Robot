...
if (!settings.includes('startPairingQuickLink') || !settings.includes('Quick Link 시작·QR 만들기') || !settings.includes("client.call('pairing.regeneratePin'")) throw new Error('mobile connection settings cannot bootstrap a fresh secure QR from the empty state');
