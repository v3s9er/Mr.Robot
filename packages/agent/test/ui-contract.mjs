...
if (!dependenciesSource.includes("envPath('ProgramFiles(x86)')") || !dependenciesSource.includes("'--installer-type', 'portable', '--scope', 'user'")) throw new Error('cloudflared install/probe paths can diverge after WinGet installation');
