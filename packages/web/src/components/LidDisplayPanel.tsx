...
type Status = { enabled: boolean; running: boolean; supported: boolean; state: string; error: string };
...
export function LidDisplayPanel() {
  ...
  return <div className="provider-add">
    ...
    <div className="type-row">
      ...
      <Button disabled={busy || !client.isAdmin || !status?.enabled || status.running} onClick={() => void action('retry')}>감지 다시 시작</Button>
    </div>
